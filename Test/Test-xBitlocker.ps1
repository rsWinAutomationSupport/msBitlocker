...
function RunTests
{
    ...
    {
        RunTest -TestName "TestBitlocker1" -ModulesToImport "MSFT_msBitlocker" -Parameters $blParams1
    }

    if ("TestAutoBitlocker" -like $Filter)
    {
        RunTest -TestName "TestAutoBitlocker1" -ModulesToImport "MSFT_msAutoBitlocker" -Parameters $autoBlParams1
    }
}
